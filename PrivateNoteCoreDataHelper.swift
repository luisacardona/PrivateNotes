//
//  PrivateNoteCoreDataHelper.swift
//  PrivateNotes
//
...
class PrivateNoteCoreDataHelper {
    ...
    static func readNotesFromCoreData(fromManagedObjectContext: NSManagedObjectContext) -> [PrivateNote] {

        var returnedNotes = [PrivateNote]()
        ...
        do {
            ...
            fetchedNotesFromCoreData.forEach { (fetchRequestResult) in
                ...
                returnedNotes.append(PrivateNote.init(
    ...
    static func readNoteFromCoreData(
        noteIdToBeRead:           UUID,
        fromManagedObjectContext: NSManagedObjectContext) -> PrivateNote? {
